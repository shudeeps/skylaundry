  ...
  <header class="main-header">
    ...
    <a  class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
       <span class="logo-mini"><b>Sky Laundry | @if (Auth::user()->role == 1) 
                cleaner
                 @endif</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Sky Laundry @if (Auth::user()->role == 1) 
         cleaner
                 @endif</b></span>
    </a>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">CLEANER NAVIGATION</li>
        ...
        <li class="treeview" onclick="myFunction_newOrder(this)">
          <a href="#">
            <i class="fa fa-plus"></i> <span>Order CheckList</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="lte/dist/img/avatar5.png" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
...
function myFunction_newOrder(elem) {
  ...
  document.getElementById("driver_dashboard").style.display = "none";  
...
function myFunction_driverDashboard(elem) {
  ...
  document.getElementById("customer_dashboardTable").style.display = "none"; 
  document.getElementById("driver_dashboard").style.display = "block";  
