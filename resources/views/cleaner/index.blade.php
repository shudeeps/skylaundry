  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div style="display:none;margin-bottom:0px;line-height:1.1" id="successAlertDiv" class="col-md-4 col-md-offset-3  alert alert-success" role="alert">
              <p> Your request is a successfull </p>
     </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{route('cleanerprofile')}}" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Cleaner Dashboard</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      @if(Session::has('success'))
       ...
       <div class="row">
          <div>          
          @include('cleaner.dashboardCleaner')
