...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="{{route('admin.registerrole')}}">
        ...
        <li class="treeview">
          <a href="{{route('admin.cleanerdetails')}}">
            <i class="fa fa-table"></i> <span>View Cleaner</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="{{route('admin.driverdetails')}}">
            <i class="fa fa-folder"></i> <span>View Driver</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
